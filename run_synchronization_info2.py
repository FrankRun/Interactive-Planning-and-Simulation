...
def synchronization_loop(args,agent):
    """
    Entry point for sumo-carla co-simulation.
    """
    sumo_simulation = SumoSimulation(agent,args.sumo_cfg_file, args.step_length, args.sumo_host,
...
if __name__ == '__main__':
    ...
    agent.load("RL/PPO_preTrained/chery_highway4/",3000000)
    ...
    synchronization_loop(arguments,agent)
